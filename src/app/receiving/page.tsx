...
export default function ReceivingPage() {
  ...
  const waitingOrders = useMemo(
    () =>
      purchaseOrders.filter((po) =>
        ["PO Created", "Sent to Vendor", "Pending Receiving", "Received"].includes(
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="ระบบตรวจรับสินค้าและตรวจสอบคุณภาพ"
        subtitle="ติดตามการรับสินค้าจากร้านค้าและสถานะการตรวจสอบคุณภาพ"
      />
              ...
              <>
                ...
                <div className="grid gap-4 text-sm text-slate-600">
                  ...
                  <button
                    ...
                    className="inline-flex h-10 items-center justify-center rounded-xl bg-[#007946] px-4 text-sm font-semibold text-white transition hover:bg-[#005f37]"
                  >
                    รับสินค้า
                  </button>
                </div>
      ...
      <ConfirmModal
        ...
        title="ยืนยันผล QC?"
        description="กรุณายืนยัน QC ก่อนรับสินค้า"
        confirmLabel="ยืนยัน QC"
        cancelLabel="ยกเลิก"
